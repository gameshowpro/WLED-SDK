...
public class SegmentBuilder
{
    ...
    public SegmentBuilder(IWledClient? client = null)
    {
        _client = client;
    }
    ...
    {
        var info = GetClientOrThrow().GetInfoOrThrow();
    ...
    {
        GetLastSegmentOrThrow()["fx"] = GetClientOrThrow().ClampEffectId(effectId);
        return this;
    }
    ...
    {
        GetLastSegmentOrThrow()["pal"] = GetClientOrThrow().ClampPaletteId(paletteId);
        return this;
    }
    ...
    private JObject GetLastSegmentOrThrow() => _segments.LastOrDefault() ?? throw new InvalidOperationException("No segments have been added.");
    private IWledClient GetClientOrThrow() => _client ?? throw new InvalidOperationException("This operation requires a client to be provided.");
}