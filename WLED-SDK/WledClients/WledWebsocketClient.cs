...
namespace WLED_SDK.WledClients;
...
public class WledWebsocketClient : IWledClient, IDisposable
{
    ...
    /// <summary>
    /// Similar to <see cref="Models.WledState.State.TransitionDuration"/>, but only applies to the requests from this client.
    /// <br/><br/>
    /// Setting this to -1 will use <see cref="Models.WledState.State.TransitionDuration"/> instead.
    /// </summary>
